...
yet claim the complete production workflow: cut-depth filtering, material
hatching, annotation overlays, sheet layout editing, and final production
qualification remain open. The desktop Architectural tab now has a transient
...
section, invalid-frame rejection, and a no-intersection diagnostic. Existing
plan projection coverage remains unchanged.
